        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-2xl mx-auto p-8">
            <div className="mb-8">
              ...
              <div className="text-sm text-muted-foreground mb-8">ARCHITECTURE-TECH ENTHUSIAST | WEB3 EXPLORER</div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground mt-8">
                USE KEYBOARD: [H]ome [T]ab=About [Q]uests=Projects [I]nventory [C]ontact [ESC]ape
              </div>
            </div>
